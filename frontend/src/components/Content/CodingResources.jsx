  ...
  return (
    <div className="content-header">
      <>
        ...
        <p>
          Unlock a treasure trove of knowledge with TrackDSA's "Coding
          ...
          Request or contribute to the resources? <Link to="mailto:parvshah1712@gmail.com">Contact Us</Link>
        </p>
        ...
        <div className="mt-3 w-100 daddy p-3 row row-cols-1 row-cols-md-3 g-4">
          {isLoading ? (
