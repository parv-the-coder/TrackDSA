      ...
      <div className="page2 my-5" id="features">
        <div className="py-3 d-flex justify-content-center align-items-center">
          <div className="p-3 info d-flex flex-column justify-content-center align-items-center">
            <h2>Why TrackDSA? What does it offers?</h2>
            <p className="fs-4">
          ...
          >
            <div className="accordion-item">
              <h2 className="accordion-header">
                ...
                >
                  How can I sign up for TrackDSA?
                </button>
              </h2>
              <div
              ...
              >
                <div className="accordion-body">
                  Signing up for TrackDSA is easy! Simply click on the "Create
            ...
            <div className="accordion-item">
              <h2 className="accordion-header">
                ...
                >
                  How do I access coding resources on TrackDSA?
                </button>
              </h2>
              <div
              ...
              >
                <div className="accordion-body">
                  To access coding resources on TrackDSA, simply navigate to
            ...
            <div className="accordion-item">
              <h2 className="accordion-header">
                ...
                >
                  Is TrackDSA suitable for beginners?
                </button>
              </h2>
              <div
              ...
              >
                <div className="accordion-body">
                  Yes, TrackDSA is designed to cater to coders of all levels,
            ...
            <div className="accordion-item">
              <h2 className="accordion-header">
                ...
                >
                  How can I participate in coding contests on TrackDSA?
                </button>
              </h2>
              <div
              ...
              >
                <div className="accordion-body">
                  Participating in coding contests on TrackDSA is simple! Keep
            ...
            <div className="accordion-item">
              <h2 className="accordion-header">
                ...
                >
                  How do I contribute to the TrackDSA community?
                </button>
              </h2>
              <div
              ...
              >
                <div className="accordion-body">
                  Contributing to the TrackDSA community is highly encouraged!
            ...
            <div className="accordion-item">
              <h2 className="accordion-header">
                ...
                >
                  How can I report a bug or suggest a feature for TrackDSA?
                </button>
              </h2>
              <div
              ...
              >
                <div className="accordion-body">
                  ...
                  TrackDSA, please feel free to reach out to us through our
                  contact page or email us directly at
                  parvshah1712@gmail.com Your feedback is invaluable in
        ...
        <div className="container ">
          ...
          <div className="my-5 d-flex justify-content-between align-items-center">
            <div className="github">
              <a
                href="https://github.com/parv-the-coder/TrackDSA"
                target="_blank"
            ...
            <div className="linkedin">
              <a
                href="https://www.linkedin.com/in/theparvshah/"
                target="_blank"
                rel="noreferrer noopener"
              >
            ...
            <div className="mail">
              <a
                href="mailto:parvshah1712@gmail.com"
                target="_blank"
                rel="noreferrer noopener"
              >
                  ...
                  <ul className="list-unstyled text-muted">
                    ...
                    <li>
                      <Link
                        ...
                        to="mailto:parvshah1712@gmail.com"
                      >
                        Contact
                      </Link>
                    </li>
