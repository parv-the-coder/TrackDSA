...
const sendEmail = async (email, subject, verificationLink) => {
    try {
        ...
        var trans = nodemailer.createTransport({
            ...
            secure: true,
            auth: {
                user: "parvshah1712@gmail.com",
                pass: process.env.GACCOUNT_APP_PASSWORD,
            },
        });
        var mailoption = {
            from: "parvshah1712@gmail.com",
            to: email,
            subject: subject,
            html: `<!DOCTYPE html>
            <html lang="en">
            ...
            <body>
              ...
              <h1>Email Verification</h1>
                ...
                <p>Thank you for signing up with TrackDSA. To complete your registration, please click the link below:</p>
                <a href="${verificationLink}" class="verification-link">Verify Email</a>
                <p>If you didn't sign up for TrackDSA, you can ignore this email.</p>
              </div>
            </body>
